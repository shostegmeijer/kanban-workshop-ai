-- Safe Kanban Board Database Schema for Remote Supabase Project
...
DROP POLICY IF EXISTS "Enable read access for all users" ON public.columns;
DROP POLICY IF EXISTS "Enable insert access for all users" ON public.columns;
DROP POLICY IF EXISTS "Enable update access for all users" ON public.columns;
DROP POLICY IF EXISTS "Enable delete access for all users" ON public.columns;
